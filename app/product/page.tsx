...
const Products = async () => {
    ...
    return (
        <div>
            <div>
                <h2 className='text-center text-5xl mt-[20px] pt-[90px] font-bold'>Products</h2>
            </div>
            <div className="flex flex-wrap justify-center gap-6 pt-16">
                {products.map((item: Product) => (
                    <div
                        key={item.id}
                        className="bg-white shadow-lg rounded-lg p-4 w-full sm:w-1/2 md:w-1/3 lg:w-1/4 transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-2xl"
                    >
                        {/* Product Image */}
                        <Image
                            src={item.thumbnail}
                        ...
                        {/* Product Info */}
                        <div className="px-2">
                            <p className="text-gray-900 text-xl font-semibold mb-2">{item.title}</p>
                            ...
                            <p className='mb-1'>
                                Discount: <span className="text-red-500  font-semibold"> {item.discountPercentage}%</span>
                            </p>

                            <p className='text-sm text-gray-600'>Rating: <span className=' text-yellow-500 text-sm font-normal'>{item.rating} Stars </span></p>
