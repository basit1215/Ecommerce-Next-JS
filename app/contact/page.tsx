...
const Contact = () => {
  return (
    <div className='w-full px-48 text-center bg-orange-200  h-[87.4vh] mb-[1px]'>
      <h1 className='text-center text-5xl mt-[20px] pt-[80px] font-bold text-orange-700'>Contact</h1>
